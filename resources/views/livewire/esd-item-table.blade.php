                ...
                @foreach ($esdItems as $esdItem)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ App\Enums\QuantityStatus::fromQuantity($esdItem->quantity_received)->getColorClass() }}">
                                {{ $esdItem->quantity_received }}
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
