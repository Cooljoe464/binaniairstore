                    ...
                    <form action="{{ route('requisitions.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="requisition_no" id="requisition_no" value="System Generated" readonly class="mt-1 block w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            </div>

                            <div>
                                <label for="requested_by" class="block text-sm font-medium text-gray-700">Requested By</label>
                                <input type="text" name="requested_by" id="requested_by" value="{{ auth()->user()->name }}" readonly class="mt-1 block w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            </div>

                            <div>
                                <label for="part_id" class="block text-sm font-medium text-gray-700">Part Number</label>
                                <select name="part_id" id="part_id" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    <option value="">Select a part</option>
                                    @foreach($parts as $part)
                                        <option value="{{ $part->id }}" data-description="{{ $part->description }}" data-quantity="{{ $part->quantity }}">{{ $part->part_number }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="description" id="description" readonly class="mt-1 block w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md shadow-sm">
                            </div>

                            <div>
                                <label for="stock_balance" class="block text-sm font-medium text-gray-700">Stock Balance</label>
                                <input type="text" name="stock_balance" id="stock_balance" readonly class="mt-1 block w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md shadow-sm">
                            </div>

                            <div>
                                <label for="quantity_required" class="block text-sm font-medium text-gray-700">Quantity Required</label>
                                <input type="number" name="quantity_required" id="quantity_required" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
                            </div>

                            <div>
                                <label for="quantity_issued" class="block text-sm font-medium text-gray-700">Quantity Issued</label>
                                <input type="number" name="quantity_issued" id="quantity_issued" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="collectors_name" id="collectors_name" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
                            </div>
                            ...
                            <div>
                                <label for="requested_by" class="block text-sm font-medium text-gray-700">Requested By</label>
                                <input type="text" name="requested_by" id="requested_by" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
                            </div>

                            <div class="md:col-span-2">
                                <label for="additional_notes" class="block text-sm font-medium text-gray-700">Additional Notes</label>
                                <textarea name="additional_notes" id="additional_notes" rows="3" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"></textarea>
                            </div>
                        </div>
