                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="mb-4">
                                ...
                                <input type="text" name="part_number" id="part_number"
                                       ...
                                       value="{{ old('part_number', $consumable->part_number) }}" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" id="description" rows="3"
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('description', $consumable->description) }}</textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="quantity_received" id="quantity_received"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                       value="{{ old('quantity_received', $consumable->quantity_received) }}" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="status" id="status"
                                    ...
                                    @foreach(App\Enums\Status::cases() as $status)
                                        <option
                                            value="{{ $status->value }}" {{ old('status', $consumable->status->value) == $status->value ? 'selected' : '' }}>{{ $status->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="aircraft_id" id="aircraft_id"
                                    ...
                                    @foreach($aircrafts as $aircraft)
                                        <option
                                            value="{{ $aircraft->id }}" {{ old('aircraft_id', $consumable->aircraft_id) == $aircraft->id ? 'selected' : '' }}>{{ $aircraft->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="supplier_id" id="supplier_id"
                                    ...
                                    @foreach($suppliers as $supplier)
                                        <option
                                            value="{{ $supplier->id }}" {{ old('supplier_id', $consumable->supplier_id) == $supplier->id ? 'selected' : '' }}>{{ $supplier->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="location_id" id="location_id"
                                    ...
                                    @foreach($locations as $location)
                                        <option
                                            value="{{ $location->id }}" {{ old('location_id', $consumable->location_id) == $location->id ? 'selected' : '' }}>{{ $location->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="received_by_id" id="received_by_id"
                                    ...
                                    @foreach($users as $user)
                                        <option
                                            value="{{ $user->id }}" {{ old('received_by_id', $consumable->received_by_id) == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" name="received_date" id="received_date"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                       value="{{ old('received_date', $consumable->received_date->format('Y-m-d')) }}"
                                       required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" name="due_date" id="due_date"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                       value="{{ old('due_date', $consumable->due_date->format('Y-m-d')) }}" required>
                            </div>
                        </div>
